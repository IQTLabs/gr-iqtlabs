...
namespace gr {
  namespace iqtlabs {
    ...
    retune_fft::sptr
    retune_fft::make(std::string tag, int vlen, float samp_rate, float freq_start, float freq_end, int tune_step_hz, int tune_step_fft)
    {
      return gnuradio::make_block_sptr<retune_fft_impl>(
        tag, vlen, samp_rate, freq_start, freq_end, tune_step_hz, tune_step_fft);
    }

    retune_fft_impl::retune_fft_impl(std::string tag, int vlen, float samp_rate, float freq_start, float freq_end, int tune_step_hz, int tune_step_fft)
      : gr::sync_block("retune_fft",
    ...
    void retune_fft_impl::retune_now_()
    {
        ...
        tune_rx = pmt::dict_add(tune_rx, pmt::mp("freq"), pmt::from_float(double(tune_freq_)));
    ...
    int
    retune_fft_impl::work(int noutput_items,
