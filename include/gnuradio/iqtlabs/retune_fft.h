  ...
  namespace iqtlabs {
    ...
    class IQTLABS_API retune_fft : virtual public gr::block
    {
     public:
       ...
       */
      static sptr make(const std::string &tag, int vlen, int nfft, int samp_rate, uint64_t freq_start, uint64_t freq_end, int tune_step_hz, int tune_step_fft, int skip_tune_step_fft, bool fft_tune);
    };
