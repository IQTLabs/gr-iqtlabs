...
#ifndef INCLUDED_IQTLABS_VECTOR_TO_JSON_H
#define INCLUDED_IQTLABS_VECTOR_TO_JSON_H
...
typedef vector_to_json<std::int32_t> vector_to_json_ii;
typedef vector_to_json<float> vector_to_json_ff;
typedef vector_to_json<gr_complex> vector_to_json_cc;

} // namespace iqtlabs
} // namespace gr

#endif /* INCLUDED_IQTLABS_VECTOR_TO_JSON_H */
