...
#ifndef INCLUDED_IQTLABS_RETUNE_PRE_FFT_H
...
public:
  ...
  /*!
   * \brief Return a shared_ptr to a new instance of iqtlabs::retune_pre_fft.
   *
   * To avoid accidental use of raw pointers, iqtlabs::retune_pre_fft's
   * constructor is in a private implementation
   * class. iqtlabs::retune_pre_fft::make is the public interface for
...
#endif /* INCLUDED_IQTLABS_RETUNE_PRE_FFT_H */
